    ...
    <div className="relative">
      ...
      <main className="container mx-auto px-4 py-20">
        ...
        <div className="mt-16 flex items-center justify-center gap-4">
          <button
            onClick={() => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent("サンプル")}&url=${encodeURIComponent(shareURL)}`, '_blank')}
            className="inline-flex items-center gap-2 rounded-lg bg-[#1DA1F2] px-4 py-2 text-white transition-all hover:opacity-90"
          >
